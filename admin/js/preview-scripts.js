( function( $ ) {
	...
	wp.customize( 'woocommerce_customer_delivered_order_settings[heading]', function( value ) {		
		value.bind( function( wcsst_delivered_email_heading ) {
					
			var str = wcsst_delivered_email_heading;
			var res = str.replace("{site_title}", wcsst_preview.site_title);
			
			var res = res.replace("{order_number}", wcsst_preview.order_number);
				
			if( wcsst_delivered_email_heading ){				
	...
	wp.customize( 'woocommerce_customer_partial_shipped_order_settings[heading]', function( value ) {		
		value.bind( function( wcsst_partial_shipped_email_heading ) {
					
			var str = wcsst_partial_shipped_email_heading;
			var res = str.replace("{site_title}", wcsst_preview.site_title);
			
			var res = res.replace("{order_number}", wcsst_preview.order_number);
				
			if( wcsst_partial_shipped_email_heading ){				
				$( '#header_wrapper h1' ).text(res);
			} else{
				$( '#header_wrapper h1' ).text('');
			}			
	...
	wp.customize( 'woocommerce_customer_updated_tracking_order_settings[heading]', function( value ) {		
		value.bind( function( wcsst_updated_tracking_email_heading ) {
					
			var str = wcsst_updated_tracking_email_heading;
			var res = str.replace("{site_title}", wcsst_preview.site_title);
			
			var res = res.replace("{order_number}", wcsst_preview.order_number);
				
			if( wcsst_updated_tracking_email_heading ){				
				$( '#header_wrapper h1' ).text(res);
			} else{
				$( '#header_wrapper h1' ).text('');
			}			
	...
	wp.customize( 'wcsst_failure_email_heading', function( value ) {		
		value.bind( function( wcsst_failure_email_heading ) {
					
			var str = wcsst_failure_email_heading;
			var res = str.replace("{site_title}", wcsst_preview.site_title);
			
			var res = res.replace("{order_number}", wcsst_preview.order_number);
				
			if( wcsst_failure_email_heading ){				
				$( '#header_wrapper h1' ).text(res);
			} else{
				$( '#header_wrapper h1' ).text('');
			}			
